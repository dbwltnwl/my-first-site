...
export function About() {
  ...
  const defaultInfo = {
    ...
    skills: [{"icon":"globe","title":"국제적 관점의 도시·부동산 연구","description":"다양한 국가의 도시 구조·주거 문제 비교 분석"},{"icon":"search","title":"부동산 및 도시 정책 이해","description":"주거·재생·개발·인프라 등 부동산 구조와 도시 문제 연구"},{"icon":"lightbulb","title":"지역 전문성","description":"브라질 현지 정책,도시문제,시장자료 해석 능력"}],
    storyTitle: "나의 이야기",
