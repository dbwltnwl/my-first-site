...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"단국대학교","period":"2023.03 ~","description":" "},{"icon":"graduation","title":"포르투갈 교환학생","period":"2024.02~07","description":"University of Coimbra"},{"icon":"award","title":"투자자산운용사 ","period":"2025 43회","description":" "},{"icon":"award","title":"FLEX(Foreign Language EXamination)","period":" 2023-2 ","description":" "}],
